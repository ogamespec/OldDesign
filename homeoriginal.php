...
<div id="mainmenu">
    ...
    <div class="menupoint">цКЮБМЮЪ</div>
    <a href="about.html">оПН нцЕИЛ</a>
    <a href="screenshots.html">йЮПРХМЙХ</a>
    <a href="register.php">оПХЯНЕДХМХРЭЯЪ</a>
    <a href="http://board.ogame.ru" target="_blank">тНПСЛ</a>
</div>

<div id="rightmenu" class="rightmenu">
    <div id="title">дНАПН ОНФЮКНБЮРЭ Б нцЕИЛ</div>
    <div id="content">
        <div id="text1"><strong>нцЕИЛ</strong> - ЩРН <strong>ЙНЯЛХВЕЯЙЮЪ ЯРПЮРЕЦХЪ</strong>. 
<strong>рШЯЪВХ ХЦПНЙНБ</strong> БШЯРСОЮЧР <strong>НДМНБПЕЛЕММН</strong> ОПНРХБ ДПСЦ ДПСЦЮ. дКЪ ХЦПШ бЮЛ МСФЕМ БЯЕЦН КХЬЭ МНПЛЮКЭМШИ АПЮСГЕП.</div>

        <div id="register" class="bigbutton" onclick="document.location.href='register.php';">пецхярпхпсиреяэ х хцпюире!</div>
        <div id="text2">гЮПЕЦХЯРПХПСИРЕЯЭ Х НРЙПНИРЕ ДКЪ ЯЕАЪ ТЮМРЮЯРХВЕЯЙХИ ЛХП нцЕИЛ!</div>
    </div>
</div>
